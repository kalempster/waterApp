...
export class DeviceEmitter extends NativeEventEmitter {
    ...
    addListener(eventType: "devicesFlush", listener: () => any, context?: any): EmitterSubscription;
    ...
    emit(eventType: "devicesFlush"): void;
    ...
    removeAllListeners(eventType: "devicesFlush"): void;
    ...
    listenerCount(eventType: "devicesFlush"): void;
